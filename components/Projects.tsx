  ...
  return (
    <section id="projects">
      <div className="bg-theme1 flex flex-col items-start justify-center gap-10 px-6 py-16 sm:px-10 sm:py-20 lg:px-18 lg:py-26">
        <h2 className="font-orbitron text-5xl text-slate-100">Projects</h2>
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="flex grow flex-col justify-between gap-6 bg-slate-700/70 p-3">
                <h5 className="font-orbitron text-lg font-semibold text-slate-100">
                  {project.title}
                </h5>
                ...
                <div className="flex flex-wrap gap-2 text-slate-100">
                  {project.stack.map((tech) => (
                    <span
                      key={tech}
                      className="font-jet rounded-xl bg-slate-600 px-2 py-1 text-sm"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="text-theme2 font-orbitron flex w-fit items-center gap-3 text-lg font-semibold">
                  See more
