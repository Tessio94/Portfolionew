  ...
  return (
    <>
      <div className="bg-theme1 flex flex-col items-start justify-center gap-10 px-6 py-16 sm:px-10 sm:py-20 lg:px-18 lg:py-26">
        <h2 className="text-5xl text-slate-100">Frontend</h2>
        <div className="grid w-full items-stretch gap-10 rounded-2xl sm:grid-cols-2 xl:grid-cols-4">
          ...
          <Circle text="Tailwind" targetDegree={90} color="#06B6D4" />
          <Circle text="Bootstrap" targetDegree={90} color="#7952B3" />
          <Circle text="JS" targetDegree={90} color="#F7DF1E" />
          <Circle text="TS" targetDegree={90} color="#3178C6" />
          <Circle text="React" targetDegree={90} color="#61DAFB" />
          <Circle text="Next" targetDegree={90} color="#FFFFFF" />
        </div>
      </div>
      <div className="from-theme1 to-theme1/90 relative flex flex-col gap-12 bg-linear-to-b from-50% to-50% px-6 py-16 sm:px-10 sm:py-20 md:flex-row md:gap-20 md:bg-linear-to-r lg:gap-36 lg:px-18 lg:py-26">
        ...
        <div className="flex w-full flex-col items-start justify-center gap-10 md:w-1/2">
          <h2 className="text-5xl text-slate-100">Backend</h2>
          <div className="grid w-full items-stretch gap-10 rounded-2xl xl:grid-cols-2">
            ...
            <Circle text="PHP" targetDegree={75} color="#777BB4" />
          </div>
        </div>
        <div className="flex w-full flex-col items-start justify-center gap-10 max-sm:pt-15 md:w-1/2">
          <h2 className="text-5xl text-slate-100">DevOps</h2>
          <div className="grid w-full items-stretch gap-10 rounded-2xl xl:grid-cols-2">
